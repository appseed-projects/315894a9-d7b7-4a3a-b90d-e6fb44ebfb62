...
- Timestamp: `2022-05-30 19:32`
- Build ID: `315894a9-d7b7-4a3a-b90d-e6fb44ebfb62`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/315894a9-d7b7-4a3a-b90d-e6fb44ebfb62.git
$ cd 315894a9-d7b7-4a3a-b90d-e6fb44ebfb62
```
